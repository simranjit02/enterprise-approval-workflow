/* checksum : 3b6fb0eff0b2a76ac7a80eecc374467d */
@cds.external : true
...
service API_PRODUCT_SRV {
  ...
  entity A_Product {
    ...
    @sap.display.format : 'Date'
    @sap.label : 'Bonus Validity End'
    YY1_BonusValidityEnd_PRD : Date;
    @sap.unit : 'YY1_BonusPercentage_PRDU'
    @sap.label : 'Bonus Percentage'
    YY1_BonusPercentage_PRD : Decimal(15, 3);
    @sap.label : 'Bonus Percentage (Unit)'
    @sap.semantics : 'unit-of-measure'
    YY1_BonusPercentage_PRDU : String(3);
    @sap.display.format : 'Date'
    @sap.label : 'Bonus Validity Start'
    YY1_BonusValidityStart_PRD : Date;
